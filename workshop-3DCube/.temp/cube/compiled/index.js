...
var CustomComp = /*#__PURE__*/function (_Component) {
  ...
  function CustomComp(props) {
    ...
    _this2.cubeRef = /*#__PURE__*/(0, _react.createRef)(null);
  ...
  _createClass(CustomComp, [{
    ...
    value: function componentDidMount() {
      ...
      this.regl = (0, _main.default)(this.cubeRef.current, this.state.dataList, color);
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (!_.isEqual(prevState.dataList, this.state.dataList)) {
        ...
        if (/^rgba/.test(backgroundColor)) {
          var numbers = backgroundColor.match(/\d+/g);
        ...
        this.regl = (0, _main.default)(this.cubeRef.current, dataList, color);
      }
    }
  }, {
