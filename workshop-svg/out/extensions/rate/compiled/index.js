...
var CustomComp = /*#__PURE__*/function (_Component) {
  ...
  function CustomComp(props) {
    ...
    console.log('rate this.props', _this2.props);
    _this2.state = {
  ...
  _createClass(CustomComp, [{
    ...
    value: function render() {
      ...
      var starCounts = +config?.starCounts?.value || 5;
      var allowHalf = config?.allowHalf?.value === 'true' ? true : false;
      return /*#__PURE__*/_react.default.createElement(_antd.Rate, {
