...
class CustomComp extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      fileType: config?.fileType?.value || 'obj', //文件类型
      //modelUrl: null,
      modelUrl:
        config?.modelUrl?.value ||
        'https://eco-p5um.beta010.devcloud.supos.net/resource/App_91b1ad3b4b728cfd00ab8e3432eb19e6/3dload/Jeep_Renegade_2016.obj', //模型链接
      materialUrl:
        config?.materialUrl?.value ||
        'https://eco-p5um.beta010.devcloud.supos.net/resource/App_91b1ad3b4b728cfd00ab8e3432eb19e6/3dload/Jeep_Renegade_2016.mtl', //材质链接
  ...
  //主程序
  initThree = () => {
    console.log('mount ref', this.mount)
    this.loadEnvironment()
  ...
  loadModel = () => {
    ...
    if (modelUrl) {
      if (fileType == 'gltf') {
        ...
        console.log('objLoader', objLoader, modelUrl, materialUrl)
